...
#    (name = the architecture, resmlp | rescnn; ia = the factored
...
#    network; then kwargs: int_dim_res, n_blocks, and for rescnn
#    kernel_size / channels / n_blocks_cnn / gate_init), optional
